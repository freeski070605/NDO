...
try {
    ...
    $mail->Username   = 'ndotraining610@Gmail.com';                             // SMTP username
    $mail->Password   = 'xbvllryjsjvtbiqn';                             // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients - main edits
    $mail->setFrom('info@ndotraining.com', 'NDO');                   // Email Address and Name FROM
    $mail->addAddress('ndotraining610@Gmail.com', 'NDO');                           // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@ndotraining.com.com',  'No Reply');             // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'New Contact Form Lead';                                     // Email Subject
    ...
    $mail->isHTML(true);
    $mail->Subject    = 'Welcome to NDO Training'; // Custom subject
