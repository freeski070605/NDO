...
<head>
    ...
    function delayedRedirect(){
        window.location = "../contact-1-working-mail-form.html"
    }
    </script>
...
try {
    ...
    $mail->Username   = '420610collective@Gmail.com';                             // SMTP username
    $mail->Password   = '@Money2468';                             // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients - main edits
    $mail->setFrom('info@420610collective.com', 'Message from The Collective');                   // Email Address and Name FROM
    $mail->addAddress('420610collective@gmail.com', 'The Collective');                           // Email Address and Name TO - Name is optional
    $mail->addReplyTo('noreply@420610collective.com', 'Message from The Collective');             // Email Address and Name NOREPLY
    $mail->isHTML(true);                                                       
    $mail->Subject = 'New Collective Member!';                                     // Email Subject
